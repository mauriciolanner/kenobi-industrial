...
class ModeloExemploController extends Controller
{
    private $functions;
    //
    ...
    public function __construct()
    {
        ...
        $this->functions->model = 'ModelExemplo';
        $this->functions->formInfo = Form::where('slung', 'modelExemplo')->with('fluxo')->first();
