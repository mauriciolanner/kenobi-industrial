            ...
            <div class="card-body bg-white shadow-sm border-bottom rounded-top table-responsive">
                ...
                <div class="row">
                    <div class="col-md-4 mt-3">
                        <jet-label for="exemploData" value="Exemplo de data:" />
                        <jet-input id="exemploData" type="date" v-model="form.exemploData" :readonly="readonlyVerific" />

                        <small class="form-text text-danger">
                            {{ form.errors.exemploData }}
                        </small>
                    </div>

                    <div class="col-md-4 mt-3">
                        <jet-label for="exemploTexto" value="Exemplo texto:" />
                        <jet-input id="exemploTexto" type="text" v-model="form.exemploTexto" :readonly="readonlyVerific" />

                        <small class="form-text text-danger">
                            {{ form.errors.exemploTexto }}
                        </small>
                    </div>
    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                ...
                exemploData: this.formOpem.exemploData,
                exemploTexto: this.formOpem.exemploTexto,
                //camposPadrao
                taskOccurrence: '',
